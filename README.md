...
- 2x USB Type-C cables (power supply and debug)
...
- Connect the CAN_H and CAN_L lines between the two boards through the CAN bus J12 connectors:
  [<p><img src="images/FRDM-A-S32K118_CAN_Connections.png" width="600"/></p>](images/FRDM-A-S32K118_CAN_Connections.png)
